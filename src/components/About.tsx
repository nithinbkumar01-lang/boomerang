        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-8">
            ...
            <motion.p
              ...
              className="text-base md:text-lg leading-relaxed mb-20 max-w-3xl font-light"
            >
              ...
              {STATS.map((stat, i) => (
                ...
                >
                  ...
                  <div className="relative">
                    <span className="text-6xl md:text-9xl font-display font-black text-ink/5 absolute -top-10 left-0 select-none group-hover:text-ink/10 transition-colors">
                      <Counter value={stat.value} suffix={stat.suffix} />
                    </span>
                    <span className="text-4xl md:text-6xl font-display font-bold relative z-10">
                      <Counter value={stat.value} suffix={stat.suffix} />
                    </span>
                  </div>
                </motion.div>
